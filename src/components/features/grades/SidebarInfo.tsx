            ...
            <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-lg">
              ...
              <div className="mt-3 space-y-1">
                <p className="text-xs text-blue-700">
                  <span className="font-medium">Année:</span> {reportData.enrollment_details.academic_year_code}
                </p>
                <p className="text-xs text-blue-700 break-words">
                  <span className="font-medium">Curriculum:</span> {reportData.enrollment_details.curriculum_code}
                </p>
              </div>
            </div>
            <Separator />
