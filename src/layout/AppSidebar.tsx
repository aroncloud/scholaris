...
import { Book, BookOpen, GraduationCap, LayoutDashboard, FileText, Users, UserSquare, School } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  {
    icon: <BookOpen className="w-5 h-5" />, // Programme
    name: "Programmes",
    path: "/admin/programs"
  },
  {
    icon: <UserSquare className="w-5 h-5" />, // Enseignants
    name: "Enseignants",
    path: "/admin/teachers"
  },
  {
