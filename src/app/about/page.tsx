                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
                                ...
                                <div>
                                    <h3 className="heading-font text-2xl font-bold text-[#3b2c6a] mb-6">
                                        {french.about_history_title2}
                                    </h3>
                                    <p className="text-gray-600 leading-relaxed mb-4">
                                        {french.about_history_text1}
                                    </p>
                                    <p className="text-gray-600 leading-relaxed mb-4">
                                        {french.about_history_text2}
                                    </p>
                                    <p className="text-gray-600 leading-relaxed">
                                        {french.about_history_text3}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                            ...
                            <div className="bg-white rounded-3xl shadow-lg p-8 text-center">
                                ...
                                <h3 className="heading-font text-2xl font-bold text-[#3b2c6a] mb-4">
                                    {french.about_vision_subtitle2}
                                </h3>
                                <p className="text-gray-600 leading-relaxed">
                                    {french.about_vision_text}
                                </p>
                            </div>
                ...
                <section className="py-20 md:py-32 bg-white">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            {/* Technologies TIC */}
                            <div className="bg-gray-50 rounded-3xl p-8 hover:shadow-lg transition-shadow duration-300">
                                <div className="w-16 h-16 bg-[#5e45a8] rounded-2xl flex items-center justify-center mb-6">
                                    <svg
                                        className="w-8 h-8 text-white"
                                        fill="none"
                                        stroke="currentColor"
                            ...
                            <div className="text-center">
                                <div className="relative mb-6">
                                    <Image
                                        ...
                                        height={192}  // same for h-48
                                        className="object-cover rounded-full mx-auto shadow-lg"
                                    />
