...
import { BookOpen, Calendar, Download, GraduationCap, Info, Plus, Upload } from 'lucide-react';
...
export default function Page () {
    ...
    //     fetchEvaluationForCurriculum("CURR_TPMS_Y1");
    // }, [])
        ...
        <CardContent>
            <div className="flex flex-col items-center justify-center pb-4 px-4">
                ...
                <div className="space-y-2">
                    ...
                    Bienvenue dans votre utilitaire de gestion des Notes
                    </h3>
                ...
                <Alert className="text-left">
                    ...
                    <AlertDescription>
                    Une fois le curriculum sélectionné, vous pourrez accéder à l&apos;ensemble des évaluation associé.
                    </AlertDescription>
                </Alert>
                </div>
            </div>
