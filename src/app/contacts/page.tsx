...
import useContactFormLogic from "@/hooks/feature/websitepage/useContactsForm";
                ...
                >
                    ...
                    <div className="container mx-auto px-4 relative z-10 text-center">
                        <h1 className="heading-font text-4xl md:text-6xl font-bold mb-6">
                            <span className="text-[#ff9900]">{french.contacts_title}</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto leading-relaxed">
                            {french.contacts_subtitle}
                        </p>
                    </div>
                </section>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder={french.contacts_fullNamePlaceholder}
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                required
                                                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#ff9900] focus:border-transparent"
                                                placeholder={french.contacts_emailPlaceholder}
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#ff9900] focus:border-transparent"
                                            >
                                                <option value="">{french.contacts_subjectPlaceholder}</option>
                                                <option value="admission">
                                                    {french.contacts_admissionRequest}
                                                </option>
                                                <option value="formations">
                                                    {french.contacts_trainingInfo}
                                                </option>
                                                <option value="frais">
                                                    {french.contacts_tuitionFees}
                                                </option>
                                                <option value="stages">
                                                    {french.contacts_internshipsJobs}
                                                </option>
                                                <option value="autre">{french.contacts_other}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                placeholder={french.contacts_messagePlaceholder}
                                            />
                                        </div>
                                        ...
                                        >
                                            ...
                                            {french.contacts_sendMessageButton}
                                        </button>
                                    </form>
                                </div>
                            </div>
